...
.method private getInstallationAuthToken(Ljava/net/HttpURLConnection;)V
    ...
    new-instance v2, Lcom/google/firebase/remoteconfig/internal/-$$Lambda$ConfigRealtimeHttpClient$SHrMIPoyydND18ChLI5PxEAwSRM;

    invoke-direct {v2, p1}, Lcom/google/firebase/remoteconfig/internal/-$$Lambda$ConfigRealtimeHttpClient$SHrMIPoyydND18ChLI5PxEAwSRM;-><init>(Ljava/net/HttpURLConnection;)V
...
.method private setRequestParams(Ljava/net/HttpURLConnection;)V
    ...
    invoke-static {p1}, Lcom/safedk/android/internal/partials/FirebaseRemoteConfigNetworkBridge;->urlConnectionGetOutputStream(Ljava/net/URLConnection;)Ljava/io/OutputStream;
...
.method public beginRealtimeHttpStream()V
    ...
    .line 464
    :try_start_1
    invoke-static {v6}, Lcom/safedk/android/internal/partials/FirebaseRemoteConfigNetworkBridge;->httpUrlConnectionGetResponseCode(Ljava/net/HttpURLConnection;)I
...
.method public closeRealtimeHttpStream(Ljava/net/HttpURLConnection;)V
    ...
    .line 516
    invoke-static {p1}, Lcom/safedk/android/internal/partials/FirebaseRemoteConfigNetworkBridge;->httpUrlConnectionDisconnect(Ljava/net/HttpURLConnection;)V

    .line 521
    :try_start_0
    invoke-static {p1}, Lcom/safedk/android/internal/partials/FirebaseRemoteConfigNetworkBridge;->urlConnectionGetInputStream(Ljava/net/URLConnection;)Ljava/io/InputStream;
