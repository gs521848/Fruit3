...
# static fields
.field private static final A:Ljava/lang/String; = "MAIN_VIDEO"

.field private static final B:Ljava/lang/String; = "postBundle"

.field private static final C:Ljava/lang/String; = "templateURL"

.field private static final D:Ljava/lang/String; = "template_type"

.field private static final E:Ljava/lang/String; = "expiry"

.field private static final F:Ljava/lang/String; = "com.applovin.mediation.adapters.VungleMediationAdapter"

.field private static final G:Ljava/lang/String; = "adType"

.field private static final H:Ljava/lang/String; = "banner"

.field private static final I:Ljava/lang/String; = "placements"

.field private static final J:Ljava/lang/String; = "reference_id"

.field private static final K:Ljava/lang/String; = "is_incentivized"

.field private static final L:Ljava/lang/String; = "tpat"

.field private static final M:Ljava/lang/String; = "templateSettings"

.field private static final N:Ljava/lang/String; = "normal_replacements"

.field private static final O:Ljava/lang/String; = "clickUrl"

.field private static final P:Ljava/lang/String; = "ad_market_id"

.field private static final Q:Ljava/lang/String; = "CTA_BUTTON_URL"

.field private static final R:Ljava/lang/String; = "EC_CTA_URL"

.field private static final S:Ljava/lang/String; = "https://privacy.vungle.com/"

.field private static T:Lcom/safedk/android/utils/PersistentConcurrentHashMap; = null
...
.field private static U:Lcom/safedk/android/utils/PersistentConcurrentHashMap; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/safedk/android/utils/PersistentConcurrentHashMap",
            "<",
...
.field private static V:Lcom/safedk/android/utils/PersistentConcurrentHashMap; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/safedk/android/utils/PersistentConcurrentHashMap",
            "<",
...
.field private static W:Lcom/safedk/android/utils/PersistentConcurrentHashMap; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/safedk/android/utils/PersistentConcurrentHashMap",
            "<",
...
.field private static final X:J = 0xf731400L
...
.method public constructor <init>()V
    ...
    sput-object v0, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->T:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    sget-object v2, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->T:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    sput-object v0, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->U:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    sget-object v2, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->U:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    sput-object v0, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->V:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    sget-object v2, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->V:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    sput-object v0, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->W:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    sget-object v2, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->W:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    .line 109
    :goto_0
    iget-object v0, p0, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->h:Lcom/safedk/android/analytics/brandsafety/creatives/a;
    ...
    const-string v2, "(function(){var sdkId=\"{{SDK_ID}}\";var address=\"{{ADDRESS}}\";var log=function(message){try{window.webkit.messageHandlers.safedkDebug.postMessage(message)}catch(error){}};var addObservers=function(){try{var dialogboxElement=document.getElementById(\"DIALOGBOX\");if(dialogboxElement&&dialogboxElement.style&&dialogboxElement.style.visibility){var element_style_visibility=dialogboxElement.style.visibility;if(element_style_visibility==\"visible\"){window.webkit.messageHandlers.safedkNoSampling.postMessage(sdkId,address,window.outerHeight,window.outerWidth)}else{if(dialogboxElement.safedkPrivacyDialogObserver!=true){dialogboxElement.safedkPrivacyDialogObserver=true;try{var MutationObserver=window.WebKitMutationObserver||window.MutationObserver;var observer=new MutationObserver(function(mutations){mutations.forEach(function(mutation){switch(mutation.type){case\"attributes\":if(getComputedStyle(mutation.target).visibility==\"visible\"){window.webkit.messageHandlers.safedkNoSampling.postMessage(sdkId,address,window.outerHeight,window.outerWidth)}break}})});var config={attributes:true,attributeOldValue:true,attributeFilter:[\"style\"]};observer.observe(dialogboxElement,config)}catch(error){window.webkit.messageHandlers.safedkNoSamplingExc.postMessage(\"address = \"+address+\" \"+error.message+\"\\n\"+error.stack)}}}}else{var privacyPageElement=document.getElementById(\"privacy-page\");if(privacyPageElement){var privacyPageParentElement=privacyPageElement.parentElement;if(privacyPageParentElement){var computedStyle=getComputedStyle(privacyPageParentElement);if(computedStyle){var displayState=computedStyle.display;if(displayState!=\"none\"){window.webkit.messageHandlers.safedkNoSampling.postMessage(sdkId,address,window.outerHeight,window.outerWidth)}else{if(privacyPageParentElement.safedkPrivacyDialogObserver!=true){privacyPageParentElement.safedkPrivacyDialogObserver=true;try{var MutationObserver=window.WebKitMutationObserver||window.MutationObserver;var observer=new MutationObserver(function(mutations){mutations.forEach(function(mutation){switch(mutation.type){case\"attributes\":if(mutation.target.style.display!=\"none\"){window.webkit.messageHandlers.safedkNoSampling.postMessage(sdkId,address,window.outerHeight,window.outerWidth)}break}})});var config={attributes:true,attributeOldValue:true,attributeFilter:[\"style\"]};observer.observe(privacyPageParentElement,config)}catch(error){window.webkit.messageHandlers.safedkNoSamplingExc.postMessage(\"address = \"+address+\" \"+error.message+\"\\n\"+error.stack)}}}}}}}}catch(error){log(\"caught exception with error = \"+error);window.webkit.messageHandlers.safedkNoSamplingExc.postMessage(\"address = \"+address+\" \"+error.message+\"\\n\"+error.stack)}};var monitorNotifications=function(){try{var divIds=[\"ad-notification-modal\",\"gdpr-notification-view\"];for(var divId of divIds){var element=document.getElementById(divId);if(element){var className=element.className;if(element.className.endsWith(\"show\")){log(\"element.className = \"+element.className);window.webkit.messageHandlers.safedkNoSampling.postMessage(sdkId,address,window.outerHeight,window.outerWidth)}else{if(element.safedkVisibilityObserver!=true){element.safedkVisibilityObserver=true;try{var MutationObserver=window.WebKitMutationObserver||window.MutationObserver;var observer=new MutationObserver(function(mutations){mutations.forEach(function(mutation){if(mutation.type==\"attributes\"){if(mutation.target.className.endsWith(\"show\")){window.webkit.messageHandlers.safedkNoSampling.postMessage(sdkId,address,window.outerHeight,window.outerWidth)}}})});var config={attributes:true,attributeOldValue:true,attributeFilter:[\"class\"]};observer.observe(element,config)}catch(error){window.webkit.messageHandlers.safedkNoSamplingExc.postMessage(\"address = \"+address+\" \"+error.message+\"\\n\"+error.stack)}}}}}}catch(error){log(\"caught exception with error = \"+error);window.webkit.messageHandlers.safedkNoSamplingExc.postMessage(\"address = \"+address+\" \"+error.message+\"\\n\"+error.stack)}};addObservers();monitorNotifications();try{var MutationObserver=window.WebKitMutationObserver||window.MutationObserver;var observer=new MutationObserver(function(mutations){mutations.forEach(function(mutation){for(var i=0;i<mutation.addedNodes.length;i++){var node=mutation.addedNodes[i];if(node&&node.nodeName!=\"#text\"){addObservers();monitorNotifications()}}})});var config={childList:true,subtree:true};observer.observe(document,config)}catch(error){window.webkit.messageHandlers.safedkNoSamplingExc.postMessage(\"address = \"+address+\" \"+error.message+\"\\n\"+error.stack)}})();\n"
...
.method private a(Lorg/json/JSONObject;Ljava/lang/String;)Lcom/safedk/android/analytics/brandsafety/creatives/infos/CreativeInfo;
    ...
    iget-object v4, v0, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->h:Lcom/safedk/android/analytics/brandsafety/creatives/a;
    ...
    iget-object v11, v0, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->l:Ljava/lang/String;
    ...
    .line 483
    :cond_16
    invoke-virtual {v3}, Lcom/safedk/android/analytics/brandsafety/creatives/infos/VungleCreativeInfo;->z()Ljava/lang/String;
...
.method private a(Ljava/io/File;)Lcom/safedk/android/analytics/brandsafety/creatives/infos/VungleCreativeInfo;
    ...
    invoke-direct {p0, v0}, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->i(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v4, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->T:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    .line 570
    sget-object v0, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->T:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    .line 580
    invoke-virtual {v0}, Lcom/safedk/android/analytics/brandsafety/creatives/infos/VungleCreativeInfo;->E()Ljava/lang/String;
...
.method private h(Ljava/lang/String;)V
    ...
    .line 167
    sget-object v3, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->W:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
...
.method public a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 211
    sget-object v1, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->U:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
...
.method public b(Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 225
    sget-object v0, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->U:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
    ...
    .line 228
    sget-object v1, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->T:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
...
.method public b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .prologue
    .line 182
    invoke-direct {p0, p1}, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->i(Ljava/lang/String;)Ljava/lang/String;
...
.method protected b(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/c$a;)Ljava/util/List;
    ...
    .line 128
    invoke-direct {p0, p2}, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->h(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/safedk/android/analytics/brandsafety/creatives/infos/CreativeInfo;->E()Ljava/lang/String;
    ...
    .line 147
    sget-object v5, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->T:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
...
.method public i()V
    ...
    .line 645
    sget-object v0, Lcom/safedk/android/analytics/brandsafety/creatives/discoveries/l;->V:Lcom/safedk/android/utils/PersistentConcurrentHashMap;
