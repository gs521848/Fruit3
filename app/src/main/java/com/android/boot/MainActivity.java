...
import static com.applovin.mediation.unity.MaxUnityAdManager1.forwardUnityEvent;
...
import com.lemons.tomatos.scary.fruits.R;
...
public class MainActivity extends BaseGameActivity implements JniBridge {
    ...
    public void getrewardmoney(){
        try {
            ...
            job.put("adUnitId","ecfc676bdcdb1df9");
            job.put("adFormat","REWARDED");
            job.put("name","OnRewardedAdReceivedRewardEvent");
            job.put("rewardLabel","");
            job.put("rewardAmount","0");

            forwardUnityEvent(job);
    ...
    private void callJava(String msg){
        ...
        if (msg.equals("showRewardAd")){
            doAction("showRewardAd");
        }else if(msg.equals("OpenExitPopup")){
            doAction("OpenExitPopup");
        }
    }
